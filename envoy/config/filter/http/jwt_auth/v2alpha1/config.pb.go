...
type JwtAuthentication struct {
	...
	// Whitelist of URIs for fetching the distributed claims.
	DistUriWhitelist []*HttpUri `protobuf:"bytes,3,rep,name=dist_uri_whitelist,json=distUriWhitelist" json:"dist_uri_whitelist,omitempty"`
}
...
func (m *JwtAuthentication) GetDistUriWhitelist() []*HttpUri {
	if m != nil {
		return m.DistUriWhitelist
	}
	return nil
}
...
func (m *JwtAuthentication) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.DistUriWhitelist) > 0 {
		for _, msg := range m.DistUriWhitelist {
			dAtA[i] = 0x1a
			i++
			i = encodeVarintConfig(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *JwtAuthentication) Size() (n int) {
	...
	if len(m.DistUriWhitelist) > 0 {
		for _, e := range m.DistUriWhitelist {
			l = e.Size()
			n += 1 + l + sovConfig(uint64(l))
		}
	}
...
func (m *JwtAuthentication) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DistUriWhitelist", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DistUriWhitelist = append(m.DistUriWhitelist, &HttpUri{})
			if err := m.DistUriWhitelist[len(m.DistUriWhitelist)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorConfig = []byte{
	...
	,
}
